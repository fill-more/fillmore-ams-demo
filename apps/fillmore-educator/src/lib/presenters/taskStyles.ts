 ...
 *
 * @param type - TaskType ('training' | 'reading' | 'practice')
 * @param isCompleted - Whether the task is completed (returns white if completed)
...
export const getTaskColors = (
  ...
  if (isCompleted) return 'var(--white), var(--white)';
