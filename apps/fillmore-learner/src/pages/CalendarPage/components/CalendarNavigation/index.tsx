  ...
  return (
    ...
    >
      <HStack align="center" gap={8}>
        ...
        <Button variant="dark" size="small" onClick={handleToday}>
          Today
        </Button>
      ...
      <Button variant="dark" size="small" onClick={handleNewSchedule}>
        <HStack align="center" justify="center" gap={8}>
          <FontAwesomeIcon icon={faCirclePlus} size="sm" color="var(--white)" />
          <Text as="span" size={14} color="white">
            New Schedule
          </Text>
        </HStack>
      </Button>
