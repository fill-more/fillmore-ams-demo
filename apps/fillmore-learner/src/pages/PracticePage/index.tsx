...
import bgPractice from '@/assets/background-practice.png';

function PracticePage() {
  const TASK_TYPE: TaskType = 'practice';
  const { practiceStage, isLoading, loadPracticeStage } = useStageStore();
  const { dropdownOptions, stageCoordinates } = practiceStage;
  ...
  return (
    ...
    >
      <Background src={bgPractice} zIndex={-1} style={{ objectFit: 'fill' }} />
      <TaskStagePopovers
      ...
      <HStack style={{ position: 'relative' }}>
        ...
        <S.CenterContent>
          ...
          <Text as="span" size={14} color="var(--white)">
            Complete your Practice section of the course. Apply your knowledge
            in interactive scenarios to reinforce learning.
          </Text>
        </S.CenterContent>
      </HStack>
